...
{
    public class Matrix // The best thing about me, Mr. Anderson, is there are so many of me.
    {
        ...
        public static Matrix operator * (Matrix mA, Matrix mB)
        {
            ...
            result._m42 = mA._m41 * mB._m12 + mA._m42 * mB._m22 + mA._m43 * mA._m32 + mB._m42;
            result._m43 = mA._m41 * mB._m13 + mA._m42 * mB._m23 + mA._m43 * mA._m33 + mB._m43;
        ...
        public Matrix Inverse()
        {
            ...
            System.Diagnostics.Debug.Assert(Math.Abs(determinate) > Double.Epsilon, "No determinate");
            ...
            result._m33 = (_m11 * _m22 - _m22 * _m21) * oneOverDet;
