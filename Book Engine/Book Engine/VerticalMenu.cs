...
using Book_Engine.Input; // Input needs to be added for gamepad input.
...
namespace Book_Engine
{
    public class VerticalMenu
    {
        ...
        // Code added by HandleInput functionality
        bool _inDown = false;
        bool _inUp = false;
        int _currentFocus = 0;
        ...
        public void HandleInput()
        {
            ...
            else if (_input.Keyboard.IsKeyPressed(Keys.Enter) || _input.Controller.ButtonA.Pressed || _input.Controller2.ButtonA.Pressed)
            {
                OnButtonPress();
            }
        }
